<template>
  <div>
    <div class="el-menu g-page-bar">
      <span class="page-title">健康趣跟读</span>
      <el-form :inline="true">
        <el-form-item label>
          <el-input
            size="medium"
...
export default {
  name: 'testApplet-talent-index', //？？
  data() {
    return {
      title: '',
      // parentId: '4429c0fe-f2f7-d0b1-7ee0-593566582cd0', //更换
      parentId: '4c97c786-8fae-9325-9b5b-a63531f4cd0b',
      pageSize: 20,
      pageNo: 1,
      tableData: {
        categorys: [],
  ...
  methods: {
    ...
    manageAction(row) {
      ...
      this.$router.push({
        ...
        name: 'testApplet-talent-manageCourse',
        query: { categoryId: row.id } //categoryId 要变化
      })
    }
  }
}
