<!-- Hot Challenge page -->
<template>
  <div class="hot-challenge-page">
    <!-- head -->
    <div class="g-page-bar">
      <span class="page-title">xxxxxxx HotChallenge</span>
      <el-button
        class="add-btn"
        icon="el-icon-plus"
        size="mini"
...
export default {
  data() {
    ...
    return {
      PAGE_CONFIG: PAGE_CONFIGS['xxxxxxx_hotChallenge'],
      tableData: {
        data: [],
        pageData: {
          pageSize: 20,
      ...
      imageUrlList: [],
      moduleNameTypes: ['CONTEST', 'PINCAR']
    }
  },
  mixins: [xxxxxxxMixin],
  methods: {},
