      ...
      >
        ...
        <el-form-item label="封面图" prop="imgUrl">
          ...
          <upload
            ...
            :fileList="imgUrlList"
          ></upload>
          <p>* 尺寸：1035px*390px,大小控制在200kb以内</p>
        </el-form-item>
...
import {
  ...
  delBanner,
  sortBanners
} from '@/api/xxxxxxxDashboard/banners.js'
  ...
  methods: {
    ...
    editAction(row) {
      ...
      this.$nextTick(() => {
        ...
        if (this.form.imgUrl) {
          this.bannerTime = [new Date(row.startDate), new Date(row.endDate)]
          this.imgUrlList = [
            {
    ...
    sort() {
      ...
      sortBanners({ sorts: data }).then(res => {
        console.log(res)
        this.getList()
      })
    }
