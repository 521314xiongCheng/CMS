...
export function tinyMCECreatePlugins(that, editor) {
  ...
  editor.ui.registry.addButton('updatelink', {
    ...
    onAction: () => {
      ...
      var imgLink = ''
      if (editor.selection.getSel().anchorNode.localName == 'a') {
        imgLink = editor.selection.getSel().anchorNode
        imgLink.setAttribute(
          'data-rcapp',
          anchorNode.getAttribute('data-rcapp')
        )
        imgLink.setAttribute(
          'data-rcmini',
          anchorNode.getAttribute('data-rcmini')
        )
        imgLink.setAttribute(
          'data-local',
          anchorNode.getAttribute('data-local')
        )
        ...
        // editor.selection.setNode(imgLink)
        that.imglink(imgLink, attributes)
      } else {
        var addelemtA = document.createElement('a')
        addelemtA.setAttribute('href', '')
        addelemtA.setAttribute('data-rcapp', '')
        addelemtA.setAttribute('data-rcmini', '')
        addelemtA.setAttribute('data-local', '')
        addelemtA.appendChild(anchorNode)
        // editor.selection.setNode(addelemtA)
        that.imglink(addelemtA)
      }
    }
  })
  editor.ui.registry.addMenuItem('mytest', {
    ...
    onAction: () => {
      var imgLink = ''
      console.log('editor.selection', editor.selection.getSel().anchorNode)
      const anchorNode = editor.selection.getSel().anchorNode
      if (editor.selection.getSel().anchorNode.localName == 'a') {
        imgLink = editor.selection.getSel().anchorNode
        imgLink.setAttribute(
